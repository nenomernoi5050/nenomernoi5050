...
Разрабатываю внутренние сервисы, API-интеграции и автоматизацию бизнес-процессов на Django/FastAPI, PostgreSQL и Docker. Интегрирую CRM, Telegram, внешние API, Playwright и LLM; для системных задач использую C++17.
...
REST API · Bitrix24 · Telegram · Playwright
Docker · Linux · Nginx · pytest · React · TypeScript
C++17 · CMake · Unicode · OOXML
```

Открыт к проектной работе и постоянным позициям в Санкт-Петербурге, удалённо или в гибридном формате.
